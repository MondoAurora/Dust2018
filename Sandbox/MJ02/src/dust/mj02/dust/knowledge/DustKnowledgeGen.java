...
public class DustKnowledgeGen implements DustCommComponents, DustMetaComponents, DustDataComponents, DustProcComponents, DustGenericComponents {
	...
	public static void init() {
        ...
        DustUtils.accessEntity(DataCommand.setRef, DustMetaLinks.LinkDefItemTypeAdditional, DustMetaLinks.LinkDefType, DustMetaLinkDefTypeValues.LinkDefSet);
        ...
        DustUtils.accessEntity(DataCommand.setRef, DustCommLinks.UnitMainEntities, DustMetaLinks.LinkDefType, DustMetaLinkDefTypeValues.LinkDefSet);
        ...
        DustUtils.accessEntity(DataCommand.setRef, DustCommTypes.Domain, DustGenericLinks.ConnectedRequires, DustGenericTypes.Identified);
        ...
        DustUtils.accessEntity(DataCommand.setRef, DustProcTypes.Iterator, DustGenericLinks.ConnectedRequires, DustProcTypes.Relay);
        DustUtils.accessEntity(DataCommand.setRef, DustProcTypes.Iterator, DustGenericLinks.ConnectedRequires, DustGenericTypes.ContextAware);
        ...
        DustUtils.accessEntity(DataCommand.setRef, DustProcLinks.DispatcherTargets, DustMetaLinks.LinkDefType, DustMetaLinkDefTypeValues.LinkDefSet);
