...
public abstract class MontruGuiWidgetManager<BaseType> implements MontruGuiComponents, DustProcComponents.DustProcChangeListener, MontruGuiComponents.GuiChangeListener {
	...
	class WidgetUpdater implements GuiChangeListener {
		...
		DustUtilsFactory<GuiEntityInfo, Set<GuiEntityDataElement>> factDataWidgets = new DustUtilsFactory<GuiEntityInfo, Set<GuiEntityDataElement>>(false){
			@Override
	...
	protected void guiChangedAttributeInt(boolean panel, GuiEntityElement e, GuiEntityInfo entity, GuiEntityInfo att, Object value) {
		e.guiChangedAttribute(entity, att, value);
	}

	protected void guiChangedRefInt(boolean panel, GuiEntityElement e, GuiEntityInfo entity, GuiRefInfo ref, DataCommand cmd) {
