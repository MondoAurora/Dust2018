...
public interface DustBaseServices extends DustBaseComponents {
	...
	interface DustBaseSource {
		...
		DustBaseEntity dustSourceGet(DustBaseType type, String srcId, String revId) throws Exception;
		void dustSourceFind(DustBaseType type, DustBaseEntity expression, DustBaseEntity processor) throws Exception;
