...
public class DustSandboxListenerDump implements DustComponents, DustGenericComponents, DustProcComponents,
	...
	public void dustProcListenerProcessChange() throws Exception {
		DustUtilsDev.dump("Dump change", EntityResolver.getKey(DustUtils.getMsgVal(DustProcLinks.ChangeCmd, true)), "\n :",
				DustUtils.getMsgVal(DustProcLinks.ChangeEntity, true), ".", DustUtils.getMsgVal(DustProcLinks.ChangeKey, true), "\n ",
				DustUtils.getMsgVal(DustProcAtts.ChangeOldValue, true), ">", DustUtils.getMsgVal(DustProcAtts.ChangeNewValue, true));
	}
